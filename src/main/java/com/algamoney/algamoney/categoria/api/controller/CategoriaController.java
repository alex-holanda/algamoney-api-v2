...
public class CategoriaController {
	...
	@GetMapping
	public ResponseEntity<CollectionModel<CategoriaModel>> search() {
	...
	public ResponseEntity<CategoriaModel> getOne(@PathVariable UUID categoriaId) {
		var categoria = categoriaService.getById(categoriaId);
	...
	@PostMapping
	public ResponseEntity<CategoriaModel> salvar(@Valid @RequestBody CategoriaInput categoriaInput) {
